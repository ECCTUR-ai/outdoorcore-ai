...
export function FinanceSummaryCard() {
  const points = [
    'Samsung tahsilatlarında gecikme bulunmuyor.',
    'THY\'nin ilk taksiti 5 gün içinde tahsil edilmeli.',
    'Mercedes faturasında gecikme riski oluştu.',
    'Haziran sonunda beklenen tahsilat: ₺42.8M.',
    'Genel tahsilat başarı oranı: %96.8.'
  ];
