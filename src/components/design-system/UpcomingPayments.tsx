          ...
          >
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="space-y-0.5 truncate leading-none">
                <span className="text-white font-extrabold block truncate leading-none">{item.clientName}</span>
                <span className="text-[8px] text-slate-550 font-bold block mt-0.5 uppercase tracking-wide">
